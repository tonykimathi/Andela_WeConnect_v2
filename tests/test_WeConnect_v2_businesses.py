...
class BusinessTestCase(unittest.TestCase):
    ...
    def test_failed_business_registration(self):
        ...
        create_business = {"business_name": None,
                           "description": "This is a school founded in 2015",
                           "category": "School",
                           "location": "Meru"
                           }
        create_business2 = {"business_name": "Andela",
                            "description": None,
                            "category": "School",
                            "location": "Meru"
                            }
        create_business3 = {"business_name": "Andela",
                            "description": "This is a school founded in 2015",
                            "category": None,
                            "location": "Meru"
                            }
        create_business4 = {"business_name": "Andela",
                            "description": "This is a school founded in 2015",
                            "category": "School",
                            "location": None
                            }
        ...
        business_response2 = self.client.post("/api/v2/auth/businesses",
        ...
        business_response3 = self.client.post("/api/v2/auth/businesses",
                                              data=json.dumps(create_business3),
                                              content_type="application/json",
                                              headers=dict(
                                                  Authorization='Bearer ' + json.loads(
                                                      login_response.data.decode()
        ...
        business_response4 = self.client.post("/api/v2/auth/businesses",
                                              data=json.dumps(create_business4),
                                              content_type="application/json",
                                              headers=dict(
                                                  Authorization='Bearer ' + json.loads(
                                                      login_response.data.decode()
    ...
    def test_successful_business_update(self):
        ...
        fail_update_response = self.client.put("/api/v2/auth/businesses/3",
                                               data=json.dumps(update_business),
                                               content_type="application/json",
                                               headers=dict(
                                                   Authorization='Bearer ' + json.loads(
    ...
    def test_view_all_businesses(self):
        ...
        business_response3 = self.client.get("/api/v2/auth/businesses?location=Meru",
                                             content_type="application/json",
                                             headers=dict(
                                                 Authorization='Bearer ' + json.loads(
                                                     login_response.data.decode()
        ...
        business_response2 = self.client.get("/api/v2/auth/businesses?q=Tenth",
                                             content_type="application/json",
                                             headers=dict(
                                                 Authorization='Bearer ' + json.loads(
                                                     login_response.data.decode()
    ...
    def test_delete_business(self):
        ...
        business_response = self.client.delete("/api/v2/auth/businesses/1",
                                               content_type="application/json",
                                               headers=dict(
                                                   Authorization='Bearer ' + json.loads(
                                                       login_response.data.decode()
